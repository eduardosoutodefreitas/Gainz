...
const Footer = () => {
  return (
    <footer className='p-5'>
      <div className='w-full container mx-auto flex flex-col items-center gap-8 sm:flex-row justify-center sm:justify-between'>
        <Logo size='small' />
        <div className='w-full sm:w-4/6 max-w-xl flex flex-col xs:flex-row justify-between items-center gap-5 xs:gap-0'>
          <Link
        ...
        <div className='w-full xs:w-[200px] flex items-center justify-center gap-5'>
          {socials.map((social) => (
